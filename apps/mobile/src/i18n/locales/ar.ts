...
export const ar: Messages<typeof en> = {
  ...
  order: {
    you: 'إنت',
    host: 'المضيف',
    loadError: 'معرفناش نحمّل الصفحة. حاول تاني.',
    subtotal: 'الإجمالي',
    remove: 'شيل',
    menuEmpty: 'لسه مفيش أصناف في المنيو.',
    cartEmpty: 'السلة فاضية.',
    browseMenu: 'شوف المنيو',
    lockedLocked: 'المضيف قفل السلة — مفيش تعديلات تانية ممكنة.',
    lockedBilled: 'الفاتورة اتسجلت — الأوردر اتقفل للمجموعة دي.',
    lockedSettled: 'الأوردر ده خلص — الطلب مقفول.',
    lockedCancelled: 'الأوردر ده اتلغى — الطلب مقفول.',
    groupMembersTitle: 'اللي في الأوردر ده',
    groupMemberCount: '{{count}} في الأوردر ده',
    groupHostOnlyNotice: 'دلوقتي بس المضيف يقدر يشوف أوردر الكل.',
    groupYourCart: 'سلتك',
    groupMemberBreakdownTitle: 'تفاصيل كل واحد',
    groupEmptyMemberCart: 'لسه مطلبش حاجة',
    groupViewSummary: 'اقرا الأوردر للمطعم',
    summarySubtitle: 'اقرا اللستة دي للمطعم.',
    summaryEmpty: 'لسه محدش طلب حاجة.',
    summaryTotalItems: '{{count}} صنف بالإجمالي',
